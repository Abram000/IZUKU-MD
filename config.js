...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split(" +2349172113890,")
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://sam:sam@cluster0.u1smxsv.mongodb.net/?retryWrites=true&w=majority"
global.port= process.env.PORT || 5000
global.email = 'sam@secktor.live'
global.github = 'https://github.com/excelottah6/IZUKU-MD'
global.location = 'Sultanpur IN'
global.gurl = 'https://instagram.com/' // zoeeh
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'queen Zoeeh' : process.env.BOT_NAME,
  ...
  readmessage:  process.env.READ_MESSAGE === undefined ? True
  : process.env.READ_MESSAGE,
